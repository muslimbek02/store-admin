  ...
  return (
    <div className="px-[32px] mb-[32px] flex items-center justify-between">
      <div className="flex items-center">
        <Link
          to="/"
          className="w-[48px] h-[48px] bg-[#F9F9F9] me-[16px] rounded-full text-[#4993DD] flex items-center justify-center"
        >
          <FaAngleLeft />
        </Link>
        <HeadingText>
          <span className="text-[#BDBDBD]">Магазин</span> Store Riviera
        </HeadingText>
      </div>
      <div className="flex items-center">
        <button className="px-[16px] pt-[15px] pb-[14px] bg-[#F9F9F9] text-[#BDBDBD] rounded-[12px]">
          Сбросить
        </button>
